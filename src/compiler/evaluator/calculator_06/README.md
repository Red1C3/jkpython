...
- Introduce `SourceNode`: the parent class for all the source tree nodes.
- Add support for the explorer pattern for traversing the source-tree in top-bottom & depth first order.
